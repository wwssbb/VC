...
string model = "‪D:\\NewRepo\\OpenVino_Test\\ssd_mobilenet_v2_quantized_300x300_coco_2019_01_03\\ssd_mobilenet_v2_quantized_300x300_coco_2019_01_03\\tflite_graph.pb";
string config = "D:\\NewRepo\\OpenVino_Test\\ssd_mobilenet_v2_quantized_300x300_coco_2019_01_03\\ssd_mobilenet_v2_quantized_300x300_coco_2019_01_03\\tflite_graph.pbtxt";
void dnn_tf();
void dnn_ir_tf();
...
void dnn_tf() {
	Mat src = imread("dog.jpg", IMREAD_UNCHANGED);
	if (src.empty()) {
